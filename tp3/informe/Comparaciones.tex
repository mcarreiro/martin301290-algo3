...
Corremos el grafo con k = 15 ya que como vimos antes no hay una gran variacion de tiempo de procesamiento
\begin{center}
%  \includegraphics[width=15cm]{./graficos/asdasdasdsd.png}
\end{center}
