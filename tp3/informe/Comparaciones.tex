...
Cabe destacar que el algoritmo exacto, no se deja de correr para los n $>$ 30 debido a su complejidad. Por esto y porque a partir de ese numero pega saltos tan grandes (en cuanto a tiempos de ejecucion y ciclos de procesador) que se vuelve imposible graficarlo es que decidimos probar solo hasta grafos de 30 nodos con este algoritmo.\\
Para el LocalSearch usamos la estrategia DosPorUno por las razones ya mencionadas en la seccion de ese algoritmo.\\
En el siguiente grafico se ven las corridas, en nanosegundos, de los 4 algoritmos para un mismo grafo aleatorio con probabilidad 30 (No pusimos grafos con mas de 100 nodos porque al estar corriendo los 4 algoritmos para cada grafo el tiempo de corrida se hace demasiado extenso):\\ 
